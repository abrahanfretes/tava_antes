...
from py.una.pol.tava.presenter.pboxplot.pfilterboxplot\
    import BoxPlotFilterPresenter


class BoxPlotFilter(wx.Panel):
    def __init__(self, parent, page_curves, test):
        ...
        self.InitUI()
        self.presenter = BoxPlotFilterPresenter(self, test)
