...
from py.una.pol.tava.presenter.pboxplot.pfigureboxplot\
    import BoxPlotFigurePresenter


# ------------------- Panel Para Grafico De Coordenadas Paralelas -------------
# -------------------                                  ------------------------
class BoxPlotFigure(wx.Panel):
    '''
    ...
    def __init__(self, parent, page_curves, test):
        ...
        self.presenter = BoxPlotFigurePresenter(self, test)
