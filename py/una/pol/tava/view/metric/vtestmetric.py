...
from py.una.pol.tava.presenter.metric.ptestmetric import TestMetricAddPresenter
...
class TestMetricAdd(wizmod.Wizard):
    '''Add pages to this wizard object to make it useful.'''
    def __init__(self, project):

        self.presenter = TestMetricAddPresenter(self)
