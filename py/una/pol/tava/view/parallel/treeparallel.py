...
from py.una.pol.tava.presenter.pparallel.ptreeparallel\
    import ParallelTreePresenter


# ------------------- Arbol de Archvivos e Iteraciones ------------------------
# -------------------                                  ------------------------
class ParallelTree(CT.CustomTreeCtrl):
    def __init__(self, parent, page_parallel, test):
        ...
        self.root = self.AddRoot("Parallel Coordenates")
        self.presenter = ParallelTreePresenter(self, test)
    ...
    def OnChecked(self, event):
        ...
        if self.presenter.isValidItem():
            self.page_parallel.enableButtonFigure()
        else:
            self.page_parallel.disableButtonFigure()
